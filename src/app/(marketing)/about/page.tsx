      ...
      <section style={{ background: 'var(--coral-soft)', padding: '48px 0' }}>
        <div className="container" style={{ textAlign: 'center', maxWidth: 700 }}>
          <p style={{ fontSize: 22, fontWeight: 700, color: 'var(--navy)', lineHeight: 1.5 }}>
            "Academic achievement gets measured constantly. Emotional growth barely gets measured at all. We wanted to change that."
          </p>
        ...
        <div className="container">
          ...
          <div className="rg-about-approach">
            <div className="card" style={{ borderColor: 'rgba(44,95,93,0.3)', padding: 32 }}>
              ...
              {['A wellness and emotional literacy tool', 'Grounded in developmental psychology', 'Designed for longitudinal, annual tracking', 'Parent-empowering — not parent-replacing', 'Warm, non-judgmental, and age-appropriate'].map(i => (
                <div key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start', marginBottom: 10 }}>
                  ...
                  <span style={{ fontSize: 14, color: 'var(--navy-ink)' }}>{i}</span>
                </div>
              ))}
            </div>
            <div className="card" style={{ borderColor: 'rgba(192,57,43,0.2)', padding: 32 }}>
              ...
              {['A diagnostic or clinical tool', 'A replacement for therapy or counselling', 'A pass/fail test with right or wrong answers', 'A surveillance or monitoring system', 'A substitute for talking with your child'].map(i => (
                <div key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start', marginBottom: 10 }}>
